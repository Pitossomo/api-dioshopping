...
const Cart = () => {
	...
	const handleBuy = ({ creditCardNumber, expirationDate}) => {
		alert(`Congratulation, you made a good choice. Soon your products will be heading to your address.`)
                    ...
                    <div className="modal-content">
						...
						{ endSelection 
							...
							: <div className="modal-body table-responsive">
								...
								<BuyNowButton onClick={() => setEndSelection(true)} />
							</div>
						}
